...
VALUES
    ...
    ('LaughingGal', 'Sophia', 'Martinez', '1995-09-22', 'sophia@example.com', 'SmilingSophie', 'Mexico', 'North America', '2024-03-12', 0, 0, 'With a laugh as infectious as the stories I share, I journey through the comedic landscape, sprinkling humor into every panel.', 'Comedy, Anthology'),
    ('MysticScribe', 'Elijah', 'Chang', '1980-01-08', 'elijah@email.com', 'MagicInk', 'Canada', 'North America', '2024-03-20', 0, 0, 'With ancient words and arcane ink, I conjure tales of magic and mystery, inviting you to explore realms beyond imagination.', 'Fantasy, Adventure, Thriller'),
    ('GalacticHero', 'Luke', 'Williams', '1982-06-30', 'luke@example.com', 'HeroicLuke', 'United States', 'North America', '2024-03-15', 0, 0, 'In the vast expanse of the cosmos, I soar as a beacon of hope, defending the innocent and vanquishing the forces of darkness.', 'Science Fiction, Superhero, Adventure'),
    ('EternalWanderer', 'Sofia', 'Kumar', '1998-03-17', 'sofia@email.com', 'WanderingSoul', 'India', 'Asia', '2024-03-08', 0, 0, 'Boundless and free, I journey through realms unknown, seeking stories that stir the soul and ignite the imagination.', 'Fantasy, Adventure, Thriller'),
    ('TechnoTales', 'Michael', 'Nguyen', '1991-08-19', 'michael@example.com', 'TechWizard', 'Canada', 'North America', '2024-03-21', 0, 0, 'Amidst the whir of machines and the glow of screens, I craft tales where technology blurs the line between reality and fiction.', 'Science Fiction, Thriller, Adventure'),
    ('WhimsicalWizard', 'Olivia', 'Garcia', '1987-12-12', 'olivia@email.com', 'WhimsyWiz', 'Spain', 'Europe', '2024-03-16', 0, 0, 'With a flick of my wand and a sprinkle of imagination, I conjure stories that shimmer with magic and wonder, inviting you to believe in the impossible.', 'Fantasy, Adventure'),
    ('SpaceScribbler', 'Grace', 'Adams', '1993-05-25', 'grace@example.com', 'ScribbleSpace', 'Canada', 'North America', '2024-03-10', 0, 0, 'Lost in the vastness of the cosmos, I write tales that traverse galaxies, weaving together science and fiction in an endless tapestry of exploration.', 'Science Fiction, Adventure, Thriller'),
    ('LaughingLeopard', 'Max', 'Thompson', '1984-09-18', 'max@email.com', 'LeopardLaughs', 'Australia', 'Australia', '2024-03-05', 0, 0, 'With a roar of laughter, I prowl through the jungle of humor, hunting down jokes and gags to share with the world.', 'Comedy, Anthology'),
    ('PixelPioneer', 'Liam', 'Roberts', '1990-02-14', 'liam@example.com', 'PixelPioneer', 'United States', 'North America', '2024-03-18', 0, 0, 'Charting new frontiers in the digital realm, I blaze trails through pixels and code, creating worlds where imagination knows no bounds.', 'Science Fiction, Fantasy, Superhero'),
    ('MysticDreamer', 'Isabella', 'Brown', '1997-07-30', 'isabella@email.com', 'Dreamer123', 'United Kingdom', 'Europe', '2024-03-12', 0, 0, 'With eyes closed and mind open, I drift through realms of magic and mystery, painting visions of wonder with the brush of imagination.', 'Fantasy, Adventure, Thriller'),
    ('InfiniteImaginator', 'William', 'Davis', '1989-11-05', 'william@example.com', 'Imaginator', 'United States', 'North America', '2024-03-20', 0, 0, 'Infinite possibilities unfold before me as I traverse the landscape of imagination, crafting stories that defy reality and ignite the soul.', 'Fantasy, Science Fiction, Adventure'),
    ('GalacticGuardian1', 'Emma', 'Wilson', '1994-03-17', 'emma@email.com', 'GuardianEmma', 'Canada', 'North America', '2024-03-15', 0, 0, 'With courage as my shield and justice as my sword, I stand as a sentinel against the darkness that threatens the cosmos, defending all that is good and true.', 'Science Fiction, Superhero, Adventure'),
    ('EtherealEnchanter', 'Daniel', 'Martinez', '1983-06-22', 'daniel@example.com', 'EnchanterDan', 'Spain', 'Europe', '2024-03-08', 0, 0, 'In the realm where dreams and reality intertwine, I wield the power of enchantment, crafting stories that shimmer with magic and mystery.', 'Fantasy, Adventure, Thriller'),
    ('TechnoTinkerer', 'Sophie', 'Brown', '1996-08-19', 'sophie@email.com', 'TechTinker', 'United States', 'North America', '2024-03-21', 0, 0, 'With gears and gadgets at my fingertips, I tinker with the fabric of reality, weaving tales where technology blurs the line between the possible and the impossible.', 'Science Fiction, Thriller, Superhero'),
    ('WhimsicalWanderer', 'Ethan', 'Liu', '1986-12-09', 'ethan@example.com', 'WhimsyEthan', 'Australia', 'Australia', '2024-03-16', 0, 0, 'With a skip in my step and a twinkle in my eye, I wander through whimsical worlds of wonder, inviting you to join me on adventures beyond imagination.', 'Fantasy, Adventure'),
    ('EpicExplorer', 'Ava', 'Chen', '1991-04-03', 'ava@email.com', 'EpicAva', 'Canada', 'North America', '2024-03-21', 0, 0, 'Venturing into the unknown, I seek stories that transcend time and space, weaving epic tales of heroism and adventure that echo through the ages.', 'Fantasy, Science Fiction, Adventure'),
    ('CyberNinja', 'Kenji', 'Tanaka', '1993-05-20', 'kenji@example.com', 'NinjaMaster', 'Japan', 'Asia', '2024-03-19', 0, 0, 'In the neon-lit streets of the cyber city, I move like a shadow, blending ancient artistry with futuristic tech, cutting through the digital darkness.', 'Science Fiction, Thriller, Adventure'),
    ('LaughingLass', 'Hannah', 'Baker', '1984-09-08', 'hannah@email.com', 'JokerHannah', 'United States', 'North America', '2024-03-14', 0, 0, 'With a joke and a smile, I journey through the comedic landscape, bringing laughter to even the darkest corners of the comic world.', 'Comedy, Anthology, Adventure'),
    ('GalacticGazer', 'Max', 'Chen', '1990-02-12', 'max@example.com', 'GalaxyExplorer', 'Canada', 'North America', '2024-03-17', 0, 0, 'Lost among the stars, I chart courses through the cosmic expanse, exploring worlds unknown and unraveling the mysteries of the universe.', 'Science Fiction, Adventure, Fantasy'),
    ('InkSorcerer', 'Liam', 'OConnor', '1986-06-25', 'liam@email.com', 'SorcererInk', 'Ireland', 'Europe', '2024-03-13', 0, 0, 'With spells woven in ink and imagination, I conjure stories that dance on the edge of reality, inviting you to explore the realms of magic and mystery.', 'Fantasy, Adventure, Thriller'),
    ('PixelPirate', 'Emma', 'Davis', '1994-11-10', 'emma@example.com', 'PixelPlunderer', 'Australia', 'Australia', '2024-03-11', 0, 0, 'Sailing the digital seas, I plunder pixels and loot code, uncovering treasures of art and story hidden in the vast expanse of cyberspace.', 'Science Fiction, Adventure, Thriller'),
    ('MangaMaster', 'Takashi', 'Nakamura', '1989-03-03', 'takashi@email.com', 'MangaSensei', 'Japan', 'Asia', '2024-03-09', 0, 0, 'With pen in hand, I journey through the vibrant world of manga, crafting stories that blur the line between reality and fantasy, inviting you to explore the depths of imagination.', 'Manga, Fantasy, Adventure'),
    ('CyberScribe', 'Elena', 'Vasiliev', '1997-07-28', 'elena@email.com', 'DigitalScribe', 'Russia', 'Europe', '2024-03-16', 0, 0, 'In the digital archives of tomorrow, I write tales of bytes and pixels, where reality bends and cyberspace becomes a canvas for boundless imagination.', 'Science Fiction, Thriller, Superhero'),
    ('ComedicChronicler', 'Charlie', 'Johnson', '1983-04-15', 'charlie@email.com', 'ChuckleWriter', 'United States', 'North America', '2024-03-18', 0, 0, 'With wit as sharp as my pen, I spin tales that tickle the funny bone and warm the heart, inviting you to laugh along on the journey of life.', 'Comedy, Anthology, Adventure'),
    ('FantasyNavigator', 'Isabella', 'Romano', '1991-01-02', 'isabela@email.com', 'DreamWeaver', 'Italy', 'Europe', '2024-03-20', 0, 0, 'Guided by dreams and fueled by imagination, I navigate the realms of fantasy, charting courses through lands of magic and wonder.', 'Fantasy, Adventure, Anthology'),
    ('GalacticGuardian', 'Alex', 'Garcia', '1981-08-07', 'alex@example.com', 'GuardianAlex', 'United States', 'North America', '2024-03-21', 0, 0, 'A shield against the darkness of the cosmos, I stand as a guardian of justice, defending the innocent and upholding the light of hope across the stars.', 'Science Fiction, Superhero, Adventure'),
    ('InkNinja', 'Ryu', 'Tanaka', '1996-03-12', 'ryu@example.com', 'NinjaInk', 'Japan', 'Asia', '2024-03-19', 0, 0, 'Silent as the night, I wield my pen like a blade, carving tales of honor and betrayal in the shadows of the ink-stained page.', 'Fantasy, Adventure, Thriller'),
    ('JovialJester', 'Freya', 'Olsen', '1987-11-25', 'freya@email.com', 'LaughingFreya', 'Norway', 'Europe', '2024-03-14', 0, 0, 'With a jest and a grin, I traverse the comedic landscape, spinning yarns that tickle the funny bone and warm the heart.', 'Comedy, Anthology, Adventure'),
    ('AstroAdventurer', 'Leo', 'Choi', '1993-09-08', 'leo@example.com', 'StellarExplorer', 'South Korea', 'Asia', '2024-03-17', 0, 0, 'Bound for the stars, I embark on cosmic journeys, exploring the wonders of the universe and unraveling the mysteries of deep space.', 'Science Fiction, Adventure, Fantasy'),
    ('ArcaneScribe', 'Amara', 'Martinez', '1988-05-20', 'amara@email.com', 'MysticWriter', 'Mexico', 'North America', '2024-03-13', 0, 0, 'With ancient quill and enchanted parchment, I weave spells of storytelling magic, conjuring worlds of wonder and mystery.', 'Fantasy, Adventure, Thriller'),
    ('CyberCaptain', 'Ethan', 'Davis', '1995-01-30', 'ethn@example.com', 'DigitalHero', 'United States', 'North America', '2024-03-11', 0, 0, 'Navigating the digital seas, I commandeer the virtual ship, charting courses through the cyberspace frontier.', 'Science Fiction, Superhero, Thriller'),
    ('MangaMaestro', 'Yuki', 'Sato', '1989-07-03', 'yuki@email.com', 'MaestroYuki', 'Japan', 'Asia', '2024-03-09', 0, 0, 'With ink and imagination, I orchestrate tales of manga mastery, guiding readers through worlds where dreams and reality collide.', 'Manga, Fantasy, Adventure'),
    ('TechnoTeller', 'Nikolai', 'Ivanov', '1998-12-28', 'nikolai@email.com', 'CodeScribe', 'Russia', 'Europe', '2024-03-16', 0, 0, 'In the realm of ones and zeros, I spin tales of digital intrigue, where algorithms dance and virtual worlds come to life.', 'Science Fiction, Thriller, Superhero'),
    ('WhimsyWordsmith', 'Aurora', 'Moreno', '1983-10-15', 'aurora@email.com', 'EnchantedInk', 'Spain', 'Europe', '2024-03-18', 0, 0, 'With a touch of whimsy and a sprinkle of magic, I craft stories that sparkle with wonder and delight, inviting you to dream with eyes wide open.', 'Fantasy, Adventure, Anthology'),
    ('DreamWeaver', 'Luca', 'Rossi', '1991-04-02', 'luca@email.com', 'DreamerLuca', 'Italy', 'Europe', '2024-03-20', 0, 0, 'In the tapestry of dreams, I am the weaver, spinning threads of imagination into tales that transport you to realms of enchantment and wonder.', 'Fantasy, Adventure, Thriller'),
    ('GalacticGuard', 'Aiden', 'Gordon', '1980-08-25', 'aiden@example.com', 'GuardianAiden', 'United States', 'North America', '2024-03-21', 0, 0, 'A sentinel of the stars, I stand watch over the celestial expanse, defending the galaxy from threats beyond imagination.', 'Science Fiction, Superhero, Adventure'),
    ('NeonNebula', 'Luna', 'Hernandez', '1994-06-18', 'luna@email.com', 'StellarLuna', 'Mexico', 'North America', '2024-03-22', 0, 0, 'Amidst the neon glow of the cyber city, I navigate the digital cosmos, exploring realms of light and shadow where dreams become reality.', 'Science Fiction, Cyberpunk, Thriller'),
    ('WhimsicalWordsmith', 'Eva', 'Andersen', '1986-09-03', 'eva@example.com', 'EnchantedWriter', 'Denmark', 'Europe', '2024-03-23', 0, 0, 'With whimsy in my heart and magic in my pen, I craft tales that dance on the edge of imagination, inviting you to journey into worlds of wonder.', 'Fantasy, Adventure, Anthology'),
    ('PixelPioneer1', 'Oliver', 'Smith', '1990-02-28', 'oliver@email.com', 'DigitalTrailblazer', 'Canada', 'North America', '2024-03-24', 0, 0, 'In the frontier of pixels and code, I blaze trails through the digital wilderness, uncovering hidden treasures of art and narrative.', 'Science Fiction, Adventure, Thriller'),
    ('LaughingLyricist', 'Nora', 'Kumar', '1997-12-10', 'nora@example.com', 'JollyNora', 'India', 'Asia', '2024-03-25', 0, 0, 'With laughter as my muse and humor as my ink, I compose stories that sing with joy and resonate with the rhythm of life.', 'Comedy, Anthology, Adventure'),
    ('ComicCrusader', 'Maxwell', 'Chang', '1983-04-30', 'maxwell@example.com', 'HeroicMax', 'United States', 'North America', '2024-03-26', 0, 0, 'Clad in the armor of righteousness, I stand as a guardian of truth and justice, fighting for the innocent and vanquishing evil wherever it lurks.', 'Superhero, Action, Adventure');
